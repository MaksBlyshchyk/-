...
- Експорт співбесід у `.ics` файл для імпорту в Google Calendar або Outlook Calendar.
...
- Історія співбесід.
- Календар співбесід та `.ics` export для імпорту в календар.
...
- Пряму API-інтеграцію з Google Calendar або Outlook Calendar.
