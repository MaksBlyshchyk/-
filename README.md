...
7. На desktop перевірити sidebar, на mobile - bottom navigation і offcanvas-меню.
8. Увійти як `recruiter` і перевірити, що Feedbacks, Soft Skills і Recruiters недоступні.
9. Увійти як `interviewer` і перевірити доступ до Interviews, Feedbacks і Soft Skills.
